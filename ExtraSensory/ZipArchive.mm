...
-(void) OutputErrorMessage:(NSString*) msg
{
    SEL errorMessage = sel_registerName("ErrorMessage");
	if( _delegate && [_delegate respondsToSelector: errorMessage] )
		[_delegate ErrorMessage:msg];
}

-(BOOL) OverWrite:(NSString*) file
{
    SEL overWriteOperation = sel_registerName("OverWriteOperation");
	if( _delegate && [_delegate respondsToSelector: overWriteOperation] )
